...
import com.moor.imkf.demo.utils.permission.callback.ExplainReasonCallback;
...
import com.moor.imkf.demo.view.permissiondialog.MoorPermissionDialog;
...
public class PermissionBuilder {
    ...
    void showHandlePermissionDialog(final ChainTask chainTask, final boolean showReasonOrGoSettings, final List<String> permissions, String message, String positiveText, String negativeText) {
        MoorPermissionDialog dialog=new MoorPermissionDialog(activity, permissions, message, positiveText, negativeText);
        showHandlePermissionDialog(chainTask, showReasonOrGoSettings, dialog);
    }
