 ...
 * </pre>
 */
public class MoorMediaPlayTools {
    ...
    private MoorMediaPlayTools() {
        setOnCompletionListener();
        setOnErrorListener();
    }

    public static MoorMediaPlayTools getInstance() {
        return MoorMediaPlayTools.SingletonHolder.sInstance;
    }

    private static class SingletonHolder {
        private static final MoorMediaPlayTools sInstance = new MoorMediaPlayTools();
    }
    ...
    public void recycle() {
        if (mListener != null) {
            mListener.onCancel(PlayPosition);
        }
        stop();
        PlayPosition = -1;
//        mInstance = null;
    ...
    private void setOnCompletionListener() {
        mediaPlayer.setOnCompletionListener(new OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                if (mListener != null) {
                    mListener.onVoicePlayCompletion(PlayPosition);
                }
            }
        });
    }
    ...
    public interface OnVoicePlayCompletionListener {
        void onVoicePlayCompletion(int playPosition);

        void onCancel(int playPosition);
    }
}
