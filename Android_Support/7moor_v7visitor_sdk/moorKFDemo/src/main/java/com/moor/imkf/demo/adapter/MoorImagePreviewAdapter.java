...
import com.moor.imkf.demo.view.imageviewer.listener.IMoorSimpleOnImageEventListener;
...
public class MoorImagePreviewAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        View convertView = View.inflate(activity, R.layout.moor_item_photoview, null);
...
//        }
    ...
    private void loadNetImage(final int position, String url, final ProgressBar progressBar, final MoorSubsamplingScaleImageView imageView, MoorPhotoView imageGif) {
