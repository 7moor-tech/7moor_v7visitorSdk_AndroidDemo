package com.moor.imkf.demo.view.shadowlayout;
 ...
 * </pre>
 */
public class MoorShadowLayout extends FrameLayout {
    ...
    public MoorShadowLayout(Context context) {
        this(context, null);
    }

    public MoorShadowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public MoorShadowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            if (selectorType == 2) {
                if (selected) {
                    ...
                    if (stroke_color_true != -101) {
                        paintStroke.setColor(stroke_color_true);
                    }
     ...
     * 是否隐藏阴影
     *
     * @param isShowShadow isShowShadow
     */
     ...
     * 动态设置 圆角属性
     *
     * @param mCornerRadius mCornerRadius
     */
     ...
     * 动态设置阴影扩散区域
     *
     * @param mShadowLimit mShadowLimit
     */
    public void setShadowLimit(int mShadowLimit) {
        if (isShowShadow) {
            int dip5 = (int) getContext().getResources().getDimension(R.dimen.moor_shadow_dp_5);
     ...
     * 动态设置阴影颜色值
     *
     * @param mShadowColor mShadowColor
     */
    ...
    public void setLayoutBackground(int color) {
        if (layoutBackground_true != null) {
            throw new UnsupportedOperationException("使用了moor_ShadowLayoutView_moor_layoutBackground_true属性，要与moor_ShadowLayoutView_moor_layoutBackground属性统一为颜色");
        }
    ...
    public void setLayoutBackgroundTrue(int color) {
        if (layoutBackground != null) {
            throw new UnsupportedOperationException("使用了moor_ShadowLayoutView_moor_layoutBackground属性，要与moor_ShadowLayoutView_moor_layoutBackground_true属性统一为颜色");
        }
    ...
    protected void onFinishInflate() {
        ...
        if (mTextViewResId != -1) {
            ...
            if (mTextView == null) {
                throw new NullPointerException("ShadowLayout找不到moor_bindTextView，请确保绑定的资源id在ShadowLayout内");
            } else {
                if (textColor == -101) {
        ...
        if (firstView == null) {
            firstView = MoorShadowLayout.this;
    ...
    private void initAttributes(AttributeSet attrs) {
        TypedArray attr = getContext().obtainStyledAttributes(attrs, R.styleable.moor_ShadowLayout);
        if (attr == null) {
            return;
        }
        ...
        try {
            //默认是显示
            isShowShadow = !attr.getBoolean(R.styleable.moor_ShadowLayout_moor_shadowHidden, false);
            leftShow = !attr.getBoolean(R.styleable.moor_ShadowLayout_moor_shadowHiddenLeft, false);
            rightShow = !attr.getBoolean(R.styleable.moor_ShadowLayout_moor_shadowHiddenRight, false);
            bottomShow = !attr.getBoolean(R.styleable.moor_ShadowLayout_moor_shadowHiddenBottom, false);
            topShow = !attr.getBoolean(R.styleable.moor_ShadowLayout_moor_shadowHiddenTop, false);
            mCornerRadius = attr.getDimension(R.styleable.moor_ShadowLayout_moor_cornerRadius, getResources().getDimension(R.dimen.moor_shadow_dp_0));
            mCornerRadiusLeftTop = attr.getDimension(R.styleable.moor_ShadowLayout_moor_cornerRadius_leftTop, -1);
            mCornerRadiusLeftBottom = attr.getDimension(R.styleable.moor_ShadowLayout_moor_cornerRadius_leftBottom, -1);
            mCornerRadiusRightTop = attr.getDimension(R.styleable.moor_ShadowLayout_moor_cornerRadius_rightTop, -1);
            mCornerRadiusRightBottom = attr.getDimension(R.styleable.moor_ShadowLayout_moor_cornerRadius_rightBottom, -1);

            //默认扩散区域宽度
            mShadowLimit = attr.getDimension(R.styleable.moor_ShadowLayout_moor_shadowLimit, 0);
            if (mShadowLimit == 0) {
            ...
            //x轴偏移量
            mDx = attr.getDimension(R.styleable.moor_ShadowLayout_moor_shadowOffsetX, 0);
            //y轴偏移量
            mDy = attr.getDimension(R.styleable.moor_ShadowLayout_moor_shadowOffsetY, 0);
            mShadowColor = attr.getColor(R.styleable.moor_ShadowLayout_moor_shadowColor, getResources().getColor(R.color.moor_default_shadow_color));

            selectorType = attr.getInt(R.styleable.moor_ShadowLayout_moor_shapeMode, 1);
            isSym = attr.getBoolean(R.styleable.moor_ShadowLayout_moor_shadowSymmetry, true);

            //背景颜色的点击(默认颜色为白色)
            mBackGroundColor = getResources().getColor(R.color.moor_default_shadow_color);

            Drawable background = attr.getDrawable(R.styleable.moor_ShadowLayout_moor_layoutBackground);
            if (background != null) {
            ...
            Drawable trueBackground = attr.getDrawable(R.styleable.moor_ShadowLayout_moor_layoutBackground_true);
            ...
            if (mBackGroundColor_true != -101 && layoutBackground != null) {
                throw new UnsupportedOperationException("使用了moor_ShadowLayoutView_moor_layoutBackground_true属性，必须先设置moor_ShadowLayoutView_moor_layoutBackground属性。且设置颜色时，必须保持都为颜色");
            }

            if (layoutBackground == null && layoutBackground_true != null) {
                throw new UnsupportedOperationException("使用了moor_ShadowLayoutView_moor_layoutBackground_true属性，必须先设置moor_ShadowLayoutView_moor_layoutBackground属性。且设置图片时，必须保持都为图片");
            }

            //边框颜色的点击
            stroke_color = attr.getColor(R.styleable.moor_ShadowLayout_moor_strokeColor, -101);
            stroke_color_true = attr.getColor(R.styleable.moor_ShadowLayout_moor_strokeColor_true, -101);

            if (stroke_color == -101 && stroke_color_true != -101) {
                throw new UnsupportedOperationException("使用了moor_ShadowLayoutView_moor_strokeColor_true属性，必须先设置moor_ShadowLayoutView_moor_strokeColor属性");
            }

            strokeWith = attr.getDimension(R.styleable.moor_ShadowLayout_moor_strokeWith, dip2px(1));
            //规定边框长度最大不错过7dp
            if (strokeWith > dip2px(7)) {
                strokeWith = dip2px(5);
            }
            ...
            Drawable clickAbleFalseBackground = attr.getDrawable(R.styleable.moor_ShadowLayout_moor_layoutBackground_clickFalse);
            ...
            startColor = attr.getColor(R.styleable.moor_ShadowLayout_moor_startColor, -101);
            centerColor = attr.getColor(R.styleable.moor_ShadowLayout_moor_centerColor, -101);
            endColor = attr.getColor(R.styleable.moor_ShadowLayout_moor_endColor, -101);
            if (startColor != -101) {
                //说明设置了渐变色的起始色
                if (endColor == -101) {
                    throw new UnsupportedOperationException("使用了moor_ShadowLayoutView_moor_startColor渐变起始色，必须搭配终止色moor_ShadowLayoutView_moor_endColor");
                }
            }


            angle = attr.getInt(R.styleable.moor_ShadowLayout_moor_angle, 0);
            if (angle % 45 != 0) {
            ...
            if (selectorType == 3) {
                ...
                if (mBackGroundColor == -101 || mBackGroundColor_true == -101) {
                    throw new NullPointerException("使用了ShadowLayout的水波纹，必须设置使用了moor_ShadowLayoutView_moor_layoutBackground和使用了moor_ShadowLayoutView_moor_layoutBackground_true属性，且为颜色值");
                }
            ...
            mTextViewResId = attr.getResourceId(R.styleable.moor_ShadowLayout_moor_bindTextView, -1);
            textColor = attr.getColor(R.styleable.moor_ShadowLayout_moor_textColor, -101);
            textColor_true = attr.getColor(R.styleable.moor_ShadowLayout_moor_textColor_true, -101);
            text = attr.getString(R.styleable.moor_ShadowLayout_moor_text);
            text_true = attr.getString(R.styleable.moor_ShadowLayout_moor_text_true);

            isClickable = attr.getBoolean(R.styleable.moor_ShadowLayout_clickable, true);
...
//            rect_left = 0;
            float maxLeftTop = Math.max(cornerRadius, mCornerRadiusLeftTop);
            float maxLeftBottom = Math.max(cornerRadius, mCornerRadiusLeftBottom);
...
//            rect_top = 0;
            float maxLeftTop = Math.max(cornerRadius, mCornerRadiusLeftTop);
            float maxRightTop = Math.max(cornerRadius, mCornerRadiusRightTop);
...
//            rect_right = shadowWidth;
            float maxRightTop = Math.max(cornerRadius, mCornerRadiusRightTop);
            float maxRightBottom = Math.max(cornerRadius, mCornerRadiusRightBottom);
...
//            rect_bottom = shadowHeight;
        ...
        if (mCornerRadiusLeftBottom == -1 && mCornerRadiusLeftTop == -1 && mCornerRadiusRightTop == -1 && mCornerRadiusRightBottom == -1) {
            //如果没有设置整个属性，那么按原始去画
            ...
            shadowPaint.setAntiAlias(true);
            int leftTop;
            if (mCornerRadiusLeftTop == -1) {
                leftTop = (int) mCornerRadius / 4;
            } else {
                leftTop = (int) mCornerRadiusLeftTop / 4;
            }
            int leftBottom;
            if (mCornerRadiusLeftBottom == -1) {
                leftBottom = (int) mCornerRadius / 4;
            } else {
                leftBottom = (int) mCornerRadiusLeftBottom / 4;
            }

            int rightTop;
            if (mCornerRadiusRightTop == -1) {
                rightTop = (int) mCornerRadius / 4;
            } else {
                rightTop = (int) mCornerRadiusRightTop / 4;
            }

            int rightBottom;
            if (mCornerRadiusRightBottom == -1) {
                rightBottom = (int) mCornerRadius / 4;
            } else {
                rightBottom = (int) mCornerRadiusRightBottom / 4;
            }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (getChildAt(0) != null) {
            if (mCornerRadiusLeftTop == -1 && mCornerRadiusLeftBottom == -1 && mCornerRadiusRightTop == -1 && mCornerRadiusRightBottom == -1) {
                //说明没有设置过任何特殊角、且是半圆。
                    ...
                    if (selectorType != 3) {
                        if (layoutBackground == null && layoutBackground_true == null) {
                            ...
                            if (stroke_color != -101) {
                                ...
                                int the_height_stoke = (int) (rectf.bottom - strokeWith / 2 - rectf.top - strokeWith / 2);
                                int trueCorner = (int) (trueHeight * the_height_stoke / 2 / the_height);

                                RectF rectFStroke = new RectF(rectf.left + strokeWith / 2, rectf.top + strokeWith / 2, rectf.right - strokeWith / 2, rectf.bottom - strokeWith / 2);
                                canvas.drawRoundRect(rectFStroke, trueCorner, trueCorner, paintStroke);
    ...
    public float[] getCornerValue(int trueHeight) {
        ...
        if (mCornerRadiusLeftTop == -1) {
            ...
            leftTop = (int) mCornerRadiusLeftTop;
        }
        ...
        if (mCornerRadiusRightTop == -1) {
            ...
            rightTop = (int) mCornerRadiusRightTop;
        }
        ...
        if (mCornerRadiusRightBottom == -1) {
            ...
            rightBottom = (int) mCornerRadiusRightBottom;
        }
        ...
        if (mCornerRadiusLeftBottom == -1) {
            ...
            leftBottom = (int) mCornerRadiusLeftBottom;
        }
    ...
    private void setSpaceCorner(Canvas canvas, int trueHeight) {
        ...
        if (stroke_color != -101) {
            if (selectorType != 3) {
                ...
                float[] outerR_stroke = getCornerValueOther(trueHeight, (int) strokeWith);
                ShapeDrawable mDrawablesStroke = new ShapeDrawable(new RoundRectShape(outerR_stroke, null, null));
                mDrawablesStroke.getPaint().setColor(paintStroke.getColor());
                mDrawablesStroke.getPaint().setStyle(Paint.Style.STROKE);
                mDrawablesStroke.getPaint().setStrokeWidth(strokeWith);
                mDrawablesStroke.setBounds((int) (leftPadding + strokeWith / 2), (int) (topPadding + strokeWith / 2), (int) (getWidth() - rightPadding - strokeWith / 2), (int) (getHeight() - bottomPadding - strokeWith / 2));
    ...
    public void setTextColor_true(int textColor_true) {
        this.textColor_true = textColor_true;
    }
