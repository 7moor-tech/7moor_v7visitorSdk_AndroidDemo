...
import com.moor.imkf.demo.activity.MoorImagePreviewActivity;
import com.moor.imkf.demo.view.imageviewer.listener.OnBigImageClickListener;
import com.moor.imkf.demo.view.imageviewer.listener.OnBigImageLongClickListener;
...
public class MoorImagePreview {
    ...
    @DrawableRes
    private int closeIconResId = R.drawable.moor_icon_chat_pic;
    @DrawableRes
    private int downIconResId = R.drawable.moor_icon_chat_pic;

    // 加载失败时的占位图
    @DrawableRes
    private int errorPlaceHolder = R.drawable.moor_icon_chat_pic;
    ...
    public void reset() {
        ...
        closeIconResId = R.drawable.moor_icon_chat_pic;
        downIconResId = R.drawable.moor_icon_chat_pic;
        errorPlaceHolder = R.drawable.moor_icon_chat_pic;
