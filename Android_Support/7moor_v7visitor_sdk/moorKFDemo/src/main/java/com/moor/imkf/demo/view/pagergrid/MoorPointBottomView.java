 ...
 * </pre>
 */
public class MoorPointBottomView extends View {
    ...
    public MoorPointBottomView(Context context) {
        super(context);
        initColors(0xFFFFFFFF, 0xFFD9D9D9);
    }


    public MoorPointBottomView(Context context, AttributeSet attrs) {
        super(context, attrs);
        // Retrieve styles attributs
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.moor_PointBottomView);

        try {
            // Retrieve the colors to be used for this view and apply them.
            int fillColor = a.getColor(R.styleable.moor_PointBottomView_moor_fillColor,
                    0xFFFFFFFF);
            int strokeColor = a.getColor(
                    R.styleable.moor_PointBottomView_moor_point_strokeColor, 0xFFD9D9D9);
            // Retrieve the radius
            radius = (int) a.getDimension(R.styleable.moor_PointBottomView_moor_radius,
                    radius);
            circleInterval = (int) a.getDimension(
                    R.styleable.moor_PointBottomView_moor_circleInterval, radius);
