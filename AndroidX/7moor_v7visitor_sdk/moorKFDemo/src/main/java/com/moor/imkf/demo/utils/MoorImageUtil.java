...
public class MoorImageUtil {
    ...
    private static final int MOOR_IMAGEVIEW_MAX = MoorPixelUtil.dp2px(160);//会话图片消息默认宽高
    private static final int MOOR_IMAGEVIEW_MIN = MoorPixelUtil.dp2px(80);//会话图片消息最小宽高
    ...
    public static boolean isLongImage(Context context, String imagePath) {
        ...
        float phoneRatio = MoorScreenUtils.getPhoneRatio(context.getApplicationContext()) + 0.1F;
    ...
    public static boolean isSmallImage(Context context, String imagePath) {
        int[] wh = getWidthHeight(imagePath);
        boolean isSmallImage = wh[0] < MoorScreenUtils.getScreenWidth(context.getApplicationContext());
        return isSmallImage;
    }
    ...
    public static float getLongImageMinScale(Context context, String imagePath) {
        int[] wh = getWidthHeight(imagePath);
        float imageWid = wh[0];
        float phoneWid = MoorScreenUtils.getScreenWidth(context.getApplicationContext());
    ...
    public static float getWideImageDoubleScale(Context context, String imagePath) {
        int[] wh = getWidthHeight(imagePath);
        float imageHei = wh[1];
        float phoneHei = MoorScreenUtils.getScreenHeight(context.getApplicationContext());
    ...
    public static MoorImageInfoBean resizeImageView(float bitmapW, float bitmapH) {
        ...
        if (bitmapW > bitmapH) {
            ...
            if (scale >= 3.0) {
                ...
                imageInfoBean.setLayoutW(MOOR_IMAGEVIEW_MAX + MoorPixelUtil.dp2px(differDp));
