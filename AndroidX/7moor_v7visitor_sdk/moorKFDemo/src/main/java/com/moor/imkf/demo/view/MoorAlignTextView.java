 ...
 *     @author : Trial
 *     @time   : 2021/5/15
 *     @desc   : 两端对齐的text view，可以设置最后一行靠左，靠右，居中对齐
 *     @version: 1.0
 * </pre>
 */
public class MoorAlignTextView extends AppCompatTextView {
    ...
    public MoorAlignTextView(Context context) {
        super(context);
        setTextIsSelectable(false);
    }

    public MoorAlignTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setTextIsSelectable(false);
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.moor_AlignTextView);

        int alignStyle = ta.getInt(R.styleable.moor_AlignTextView_moor_align, 1);
        switch (alignStyle) {
            case 1:
