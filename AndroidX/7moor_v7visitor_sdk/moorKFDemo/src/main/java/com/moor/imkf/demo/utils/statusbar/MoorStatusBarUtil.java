package com.moor.imkf.demo.utils.statusbar;
 ...
 * </pre>
 */
public class MoorStatusBarUtil {
    ...
    public static void setStatusBarColor(Activity activity, int colorId) {
        ...
        if (MoorSdkVersionUtil.over21()) {
            ...
            MoorSystemBarTintManager systemBarTintManager = new MoorSystemBarTintManager(activity);
...
//            }
    ...
    public static boolean setStatusBarDarkTheme(Activity activity, boolean dark) {
        if (MoorSdkVersionUtil.over19()) {
            if (MoorSdkVersionUtil.over23()) {
                setStatusBarFontIconDark(activity, TYPE_M, dark);
            } else if (MoorOsUtils.isMiui()) {
                setStatusBarFontIconDark(activity, TYPE_MIUI, dark);
            } else if (MoorOsUtils.isFlyme()) {
