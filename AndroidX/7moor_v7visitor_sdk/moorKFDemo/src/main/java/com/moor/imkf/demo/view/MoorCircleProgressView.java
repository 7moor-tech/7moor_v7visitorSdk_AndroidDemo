 ...
 * </pre>
 */
public class MoorCircleProgressView extends View {
    ...
    public MoorCircleProgressView(Context context) {
        super(context);
    }

    public MoorCircleProgressView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MoorCircleProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.moor_CircleProgress);
        mProgress = typedArray.getInt(R.styleable.moor_CircleProgress_moor_circleProgress, 0);
        mCorner = typedArray.getDimensionPixelOffset(R.styleable.moor_CircleProgress_moor_circleCorner, 0);
        mStartAngle = typedArray.getInt(R.styleable.moor_CircleProgress_moor_startAngle, 315);
        mBackgroundColor = typedArray.getColor(R.styleable.moor_CircleProgress_moor_backgroundColor,
