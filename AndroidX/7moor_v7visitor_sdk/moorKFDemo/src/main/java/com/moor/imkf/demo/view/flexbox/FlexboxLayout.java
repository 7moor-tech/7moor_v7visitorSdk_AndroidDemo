...
public class FlexboxLayout extends ViewGroup implements FlexContainer {
    ...
    public FlexboxLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.moor_FlexboxLayout, defStyleAttr, 0);
        mFlexDirection = a
                .getInt(R.styleable.moor_FlexboxLayout_moor_flexDirection, FlexDirection.ROW);
        mFlexWrap = a.getInt(R.styleable.moor_FlexboxLayout_moor_flexWrap, FlexWrap.NOWRAP);
        mJustifyContent = a
                .getInt(R.styleable.moor_FlexboxLayout_moor_justifyContent, JustifyContent.FLEX_START);
        mAlignItems = a.getInt(R.styleable.moor_FlexboxLayout_moor_alignItems, AlignItems.STRETCH);
        mAlignContent = a.getInt(R.styleable.moor_FlexboxLayout_moor_alignContent, AlignContent.STRETCH);
        mMaxLine = a.getInt(R.styleable.moor_FlexboxLayout_moor_maxLine, NOT_SET);
        Drawable drawable = a.getDrawable(R.styleable.moor_FlexboxLayout_moor_dividerDrawable);
        if (drawable != null) {
            setDividerDrawableHorizontal(drawable);
            setDividerDrawableVertical(drawable);
        }
        Drawable drawableHorizontal = a
                .getDrawable(R.styleable.moor_FlexboxLayout_moor_dividerDrawableHorizontal);
        if (drawableHorizontal != null) {
            setDividerDrawableHorizontal(drawableHorizontal);
        }
        Drawable drawableVertical = a
                .getDrawable(R.styleable.moor_FlexboxLayout_moor_dividerDrawableVertical);
        if (drawableVertical != null) {
            setDividerDrawableVertical(drawableVertical);
        }
        int dividerMode = a.getInt(R.styleable.moor_FlexboxLayout_moor_showDivider, SHOW_DIVIDER_NONE);
        ...
        int dividerModeVertical = a
                .getInt(R.styleable.moor_FlexboxLayout_moor_showDividerVertical, SHOW_DIVIDER_NONE);
        if (dividerModeVertical != SHOW_DIVIDER_NONE) {
            mShowDividerVertical = dividerModeVertical;
        }
        int dividerModeHorizontal = a
                .getInt(R.styleable.moor_FlexboxLayout_moor_showDividerHorizontal, SHOW_DIVIDER_NONE);
    ...
    public static class LayoutParams extends MarginLayoutParams implements FlexItem {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            ...
            TypedArray a = context
                    .obtainStyledAttributes(attrs, R.styleable.moor_FlexboxLayout_Layout);
            mOrder = a.getInt(R.styleable.moor_FlexboxLayout_Layout_moor_layout_order, ORDER_DEFAULT);
            mFlexGrow = a
                    .getFloat(R.styleable.moor_FlexboxLayout_Layout_moor_layout_flexGrow, FLEX_GROW_DEFAULT);
            mFlexShrink = a.getFloat(R.styleable.moor_FlexboxLayout_Layout_moor_layout_flexShrink,
                    FLEX_SHRINK_DEFAULT);
            mAlignSelf = a
                    .getInt(R.styleable.moor_FlexboxLayout_Layout_moor_layout_alignSelf, AlignSelf.AUTO);
            mFlexBasisPercent = a
                    .getFraction(R.styleable.moor_FlexboxLayout_Layout_moor_layout_flexBasisPercent, 1, 1,
                            FLEX_BASIS_PERCENT_DEFAULT);
            mMinWidth = a
                    .getDimensionPixelSize(R.styleable.moor_FlexboxLayout_Layout_moor_layout_minWidth, 0);
            mMinHeight = a
                    .getDimensionPixelSize(R.styleable.moor_FlexboxLayout_Layout_moor_layout_minHeight, 0);
            mMaxWidth = a.getDimensionPixelSize(R.styleable.moor_FlexboxLayout_Layout_moor_layout_maxWidth,
                    MAX_SIZE);
            mMaxHeight = a.getDimensionPixelSize(R.styleable.moor_FlexboxLayout_Layout_moor_layout_maxHeight,
                    MAX_SIZE);
            mWrapBefore = a.getBoolean(R.styleable.moor_FlexboxLayout_Layout_moor_layout_wrapBefore, false);
            a.recycle();
        }
