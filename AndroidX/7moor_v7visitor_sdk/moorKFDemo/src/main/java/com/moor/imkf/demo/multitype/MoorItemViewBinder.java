 ...
 * </pre>
 */
public abstract class MoorItemViewBinder<T, VH extends ViewHolder> {

    /* internal */ MoorMultiTypeAdapter adapter;
    private IMoorBinderClickListener onClickListener;
     ...
     * <p>
     * The payloads parameter is a merge list from {@link MoorMultiTypeAdapter#notifyItemChanged(int,
     * Object)} {@link MoorMultiTypeAdapter#notifyItemRangeChanged(int, int, Object)}.
    ...
    /**
     * Get the {@link MoorMultiTypeAdapter} for sending notifications or getting item count, etc.
     * <p>
     * Note that if you need to change the item's parent items, you could call this method
     * to get the {@link MoorMultiTypeAdapter}, and call {@link MoorMultiTypeAdapter#getItems()} to get
     * a list that can not be added any new item, so that you should copy the items and just use
     * {@link MoorMultiTypeAdapter#setItems(List)} to replace the original items list and update the
     * views.
     * </p>
     *
    ...
    MoorMultiTypeAdapter getAdapter() {
        if (adapter == null) {
    ...
    /**
     * Called when a view created by this {@link MoorItemViewBinder} has been recycled.
     *
    ...
    /**
     * Called when a view created by this {@link MoorItemViewBinder} has been attached to a window.
     *
     * <p>This can be used as a reasonable signal that the view is about to be seen
     * by the user. If the {@link MoorItemViewBinder} previously freed any resources in
    ...
    /**
     * Called when a view created by this {@link MoorItemViewBinder} has been detached from its
     * window.
     *
    ...
    public IMoorBinderClickListener getBinderClickListener() {
