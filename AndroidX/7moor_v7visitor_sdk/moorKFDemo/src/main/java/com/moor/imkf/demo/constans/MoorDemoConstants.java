...
public class MoorDemoConstants {
     ...
     * 会话列表局部刷新payload
     */
    public static final String MOOR_PAYLOAD_HIDE = "MOOR_PAYLOAD_HIDE";
    /**
     * 会话列表局部刷新payload
     */
     ...
     * 选择图片的 REQUEST_CODE
     */
    public static final int PICK_IMAGE_ACTIVITY_REQUEST_CODE = 0x0100;
    /**
     * 选择文件的 REQUEST_CODE
     */
    public static final int PICK_FILE_ACTIVITY_REQUEST_CODE = 0x0200;
    /**
     * 拍照 REQUEST_CODE
     */
    public static final int CAMERA_ACTIVITY_REQUEST_CODE = 0x0300;
    /**
     * 录制语音消息最大时长
     */
