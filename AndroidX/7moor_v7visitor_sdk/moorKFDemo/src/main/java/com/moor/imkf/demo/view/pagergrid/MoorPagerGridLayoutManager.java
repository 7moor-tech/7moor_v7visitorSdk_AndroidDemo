 ...
 * </pre>
 */
public class MoorPagerGridLayoutManager extends RecyclerView.LayoutManager
        implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    private static final String TAG = MoorPagerGridLayoutManager.class.getSimpleName();
     ...
     */
    public MoorPagerGridLayoutManager(@IntRange(from = 1, to = 100) int rows,
...
//        Loge("setPageIndex = " + pageIndex + ":" + isScrolling);
    ...
    public void smoothScrollToPage(int pageIndex) {
        ...
        // 具体执行滚动
        LinearSmoothScroller smoothScroller = new MoorPagerGridSmoothScroller(mRecyclerView);
