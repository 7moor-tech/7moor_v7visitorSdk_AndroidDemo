...
import com.moor.imkf.demo.adapter.MoorChatTagQuestionMoreAdapter;
...
public class MoorBottomTabQuestionDialog extends BottomSheetDialogFragment {
    ...
    public static MoorBottomTabQuestionDialog init(String title, ArrayList<String> list) {
        MoorBottomTabQuestionDialog dialog=new MoorBottomTabQuestionDialog();
    ...
    public MoorBottomTabQuestionDialog() {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = View.inflate(mContext, R.layout.moor_layout_bottomtabquestion, null);
            ...
            MoorChatTagQuestionMoreAdapter adapter = new MoorChatTagQuestionMoreAdapter(list);
            rv_switch.setAdapter(adapter);
            adapter.setOnItemClickListener(new MoorChatTagQuestionMoreAdapter.onItemClickListener() {
                @Override
        ...
        if (dialog != null) {
//            View bottomSheet = dialog.findViewById(R.id.design_bottom_sheet);
            bottomSheet.getLayoutParams().height = MoorScreenUtils.getScreenHeight(getContext()) * 3 / 5;
        }
